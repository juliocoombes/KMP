...
const contenido = {
  hero: {
    ...
    cta: {
      ...
      link: "https://wa.me/message/OIPHFPU6JPUIK1",
    },
  },
  ...
  contacto: {
    titulo: "Contáctanos",
    email: "jiponcemartinez@keymarketpartners.com",
    telefono: "+54 9 11 6211-7980",
    horario: "Lunes a Viernes de 10:00 a 18:00 hs",
    redes: {
      facebook: "https://facebook.com",
      instagram: "https://instagram.com/keymarketpartners",
      youtube: "https://youtube.com/keymarketpartners",
      linkedin: "https://linkedin.com/keymarketpartners",
    },
  },
  ...
  asesoramiento: {
    ...
    descripcion: "En Key Market Partners diseñamos carteras 100% alineadas a tu horizonte y tolerancia al riesgo (conservador, moderado o dinámico). Partimos de un diagnóstico patrimonial y avanzamos con un plan medible, rebalanceos programados y reportes claros.",
    items: [
  ...
  equipo: [
    {
      ...
      titulo:
        "Licenciado en Marketing por la Universidad Católica Argentina y Magíster en Finanzas por la Universidad del CEMA",
      descripcion:
